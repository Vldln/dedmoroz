export default {
  ...
  info: 'Festival Feast After Plague is postponed to the next May, due to too slow opening of the external EU borders. Festival will be organised from 6th to 9th of May 2022. We will announce a detailed program closer to the dates. The format of the festival is longer and more relaxed than before. Parallel sessions and passive networking are encouraged - suggestions can be sent to dedmoroz@riseup.net The lecture and performance program will be complemented by raves, workshops and bodily laboratories.',
